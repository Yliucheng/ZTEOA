...
public class ExamSheetSelectWriteHandler implements SheetWriteHandler {
    @Override
    ...
    public void afterSheetCreate(WriteWorkbookHolder writeWorkbookHolder, WriteSheetHolder writeSheetHolder) {
        String[] examType = {"晨考","周考"};
        String[] studentResult = {"差","中等","好","非常好"};
        // 键是下拉框所在列的索引，值是下拉框的内容
        Map<Integer,String[]> mapDropDown = new HashMap<>();
        mapDropDown.put(3,examType);
        mapDropDown.put(4,studentResult);
