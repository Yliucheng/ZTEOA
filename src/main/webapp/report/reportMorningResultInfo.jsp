...
<div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <c:if test="${! empty resList}">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <button id="show" class="btn btn-success btn-sm">按月份导出班级学生晨考成绩信息</button>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li>
                                            <a href="javascript:doPost('report/reportmorningedit.jsp',{'id':'${res.examId}','examTypeNama':'${res.examTypeNama}','examType':'${examType}',
